...
# Brief Onboarding ResetPulse v1.0.4 (V1 - tooltips)

**Version Standalone - Conception & Implémentation**

> **Note:** Ce brief concerne l'onboarding V1 (tooltips). Voir `cockpit/active/m8-onboarding-v2.md` pour la version V2 (6 filtres) en cours.
